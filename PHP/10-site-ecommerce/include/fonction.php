...
{
    if(!isset($_SESSION['membre'])) // si le 'membre' n'est pas définit dans la sessione, cela veut donc dire que l'internaute n'est pas passé par la page connexion, donc n'est pas connecté
    {
        return false;
    }
